...
public class ProjectController {
    ...
    @RolesAllowed({Roles.ReadProject, Roles.ReadUserProject, Roles.WriteProject, Roles.AdminProject })
    ...
    @RolesAllowed({Roles.WriteProject, Roles.AdminProject})
    ...
    @RolesAllowed({Roles.WriteProject})
